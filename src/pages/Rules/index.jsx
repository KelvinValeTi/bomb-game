...
import { Container, Icon, NumberParagraph, ScrollTextRules, Title, Paragraph } from "./styles";
...
export default function Rules(){
    ...
    return(
        <Container>
            <Icon name="arrow-back-ios" onPress={handleNavToStart}></Icon>
            <ScrollTextRules>
                <Title>Jogando Solo</Title>
                <Paragraph>
                    <NumberParagraph>1 - </NumberParagraph>
                    Você vai receber uma dica da senha, que será uma conta matemática, tendo um tempo fixo de 5 minutos para resolver e desarmar a bomba
                </Paragraph>
                <Paragraph>
